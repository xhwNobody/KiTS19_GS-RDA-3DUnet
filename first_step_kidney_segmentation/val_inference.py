...
from build_RDA_3DUnet import *

test_img_path = '/home/xhw/桌面/kits19-experient-pytorch/test_Image/'
dst_pred_path = '//home/xhw/桌面/kits19-experient-pytorch/test_pred/Vnet/'
use_gpu = 1

net = UNet(n_channels=1, n_classes=2)
model = '/home/xhw/桌面/kits19-experient-pytorch/RDAUnet_record/checkpoints/CP44_val_0.944119.pth'
net.cuda()
