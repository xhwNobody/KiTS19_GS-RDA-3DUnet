...
def get_list_of_patients(data_floder):
    ...
    patients = [i[-18:-11] for i in nii_files]
    return patients
...
class Kits2019DataLoader3D(DataLoader):
    ...
    def load_patient(patient):
        data = nib.load('/home/xhw/桌面/data-augmentations/train_Image/' + patient +'_img.nii.gz')
        data = data.get_data()
        print(data.shape)
        metadata = nib.load('/home/xhw/桌面/data-augmentations/train_Mask/' + patient+'_msk.nii.gz')
...
data_path = '/home/xhw/桌面/data-augmentations/train_Image'
dst_img = '/home/xhw/桌面/data-augmentations/train_Image_aug/'
dst_msk = '/home/xhw/桌面/data-augmentations/train_Mask_aug/'
...
demo_affine = nib.load('/home/xhw/桌面/data-augmentations/train_Image/001_000_img.nii.gz').affine
for i in range(2209):
    for j in range(2):
