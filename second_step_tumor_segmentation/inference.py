...
test_img_path = '/home/xhw/桌面/kits19-experient-pytorch/val_Image/'
dst_pred_path = '/home/xhw/桌面/kits19-experient-pytorch/1fold-1234-5/val_pred/'
use_gpu = 1

net = UNet(n_channels=1, n_classes=2)
model = '/home/xhw/桌面/kits19-experient-pytorch/1fold-1234-5/CP87_val_0.979190.pth'
net.cuda()
...
for img_nii in os.listdir(test_img_path):
    ...
    msk_pred = np.round(np.argmax(msk_pred, axis=-1) + 0.)
    mskdata = nib.Nifti1Image(msk_pred, imgaffine)
    nib.save(mskdata, dst_pred_path + img_nii[:3] + '/' + img_nii[:-10]+ '_pred.nii.gz')
